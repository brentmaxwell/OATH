...
namespace Oath
{
    ...
    {
        /// <summary>
        /// Array of valid base-32 characters
        /// </summary>
        ...
        public static byte[] ToBinary(this string base32)
        {
            ...
            for (int i = 0; i < segments; i++)
            {
                ...
                var slice = ConvertSegmentToBinary(segment);
        ...
        /// <summary>
        /// Converts an 8 character base-32 encoded segment to binary.
        /// </summary>
        /// <param name="segment">An 8 character base-32 encoded string.</param>
        /// <returns>Binary data from base-32 segment</returns>
        private static IEnumerable<byte> ConvertSegmentToBinary(char[] segment)
        {
            if (segment.Length > 8)
            {
        ...
        /// <summary>
        /// Converts a 5 byte segment to Base32.
        /// </summary>
        /// <param name="segment">Binary segment (max 5 bytes)</param>
        /// <returns>Base-32 representation of binary segment.</returns>
        private static string ConvertSegmentToBase32(byte[] segment)
        {
            ...
            int accumulator = 0;
            int bitsRemaining = 5;
            byte[] masks = { 0x00, 0x01, 0x03, 0x07, 0x0F, 0x1F };
